...
// Luck-of-the-deal in a live run: `propose` needs the human to lead before the game
// ends, `quest-card` needs them picked onto an approved team, `assassinate` needs
// them dealt the Assassin after a good win. The component gallery captures all of
...
const COMPONENTS = [
  ...
  'act-propose', 'act-quest-good', 'act-quest-evil', 'act-assassinate',
